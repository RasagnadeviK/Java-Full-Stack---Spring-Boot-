...
<style>
        ...
        .team-item {
            flex: 0 0 calc(20% - 20px); /* Adjust the width of each team member item */
            max-width: calc(20% - 20px);
            margin: 10px;
            box-sizing: border-box;
        }
        /* Other styles for your overlays, buttons, etc. */
    </style>
...
<body id="page-top">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 200px;">
                <h6 class="text-primary text-uppercase">Team Members</h6>
                <h1 class="display-5 text-uppercase mb-0">Qualified Pets Care Professionals</h1>
            </div>
            <div class="d-flex flex-wrap justify-content-around">
            <div class="team-item mb-4 mx-2">
                ...
                <div class="team-item mb-4 mx-2">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/team-3.jpg" alt="img" width="300" height="200">
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-twitter"></i></a>
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-facebook"></i></a>
