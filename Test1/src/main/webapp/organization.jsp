...
<%@ include file="components/navbar.jsp"%>
    ...
    %>
    <%
    String submissionStatus = (String) request.getAttribute("submissionStatus");
    if ("success".equals(submissionStatus)) {
%>
...
<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Organization Info</h2>
			<!-- Icon Divider-->
...
<form id="contactForm" action="Organizationservlet" method="post">
    <!-- Name input -->
    <input class="form-control" name="name" type="text" placeholder="organizationname" required />
