                        ...
                        <a href="contact.jsp" class="nav-item nav-link">Contact</a>
                         <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href="index2.jsp" class="dropdown-item">Logout</a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <h4 class="text-uppercase mb-4">Mercedes Benz AMG</h4>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/p10.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">PRASANTH</h4>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/rahul2.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">SAKALA RAHUL</h4>
                        <p class="m-0">CEO</p>
                        <div class="team-social position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/charan4.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">KOLLI CHARAN</h4>
                        <p class="m-0">EXECUTIVE MANAGER</p>
                        <div class="team-social position-absolute w-100 h-100 d-flex align-items-center justify-content-center">
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/pavan3.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">PAVAN KUMAR</h4>
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
									...
									class="zmdi zmdi-account material-icons-name"></i></label><input
                                     type="text" class="form-control p-4" placeholder="Your Name" required="required">
                                </div>
                                <div class="col-6 form-group">
                                     <label for="email"><i
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start">
                    <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="http://localhost:8080/PROJECT1/index.jsp"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-lg btn-dark btn-lg-square mr-2" href="https://www.linkedin.com/in/prasanth-vanapalli-7bb93521a//"><i class="fab fa-linkedin-in"></i></a>
