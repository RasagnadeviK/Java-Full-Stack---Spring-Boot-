            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent1.jsp">$50.00/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent2.jsp">$60.00/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent3.jsp">$99.00/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent4.jsp">$49.00/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent5.jsp">$39.00/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="rent6.jsp">$89.00/Day</a>
                    </div>
                </div>
            </div>
        </div>
