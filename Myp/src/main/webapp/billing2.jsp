                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3">MERCEDES AMG</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-9 col-sm-5">DOUBLE BEDROOM</div>
                            <div class="d-none d-sm-block col-2">2</div>
                            <div class="d-none d-sm-block col-2 text-95">3000rs</div>
                            <div class="col-2 text-secondary-d2">20</div>
                        </div>

                        <div class="row mb-2 mb-sm-0 py-25 bgc-default-l4">
                            <div class="d-none d-sm-block col-1">2</div>
                            <div class="col-9 col-sm-5">Adutls</div>
                            <div class="d-none d-sm-block col-2">2</div>
                        ...
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-9 col-sm-5">Childern</div>
                        ...
                        <div class="row mb-2 mb-sm-0 py-25 bgc-default-l4">
                            ...
                            <div class="col-9 col-sm-5">Tax</div>
                            <div class="d-none d-sm-block col-2">100rs</div>
