                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="car.jsp" class="dropdown-item">Pets Listing</a>
                                <a href="detail.jsp" class="dropdown-item">Pets Detail</a>
                                <a href="booking.jsp" class="dropdown-item">Pets Booking</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
        ...
        <div class="row mx-n2">
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <select class="custom-select px-4 mb-3" style="height: 50px;">
                    <option selected>Pet Pickup Location</option>
            ...
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <select class="custom-select px-4 mb-3" style="height: 50px;">
                    <option selected>Pet Drop Location</option>
                    <option value="1">Location 1</option>
                    <option value="2">Location 2</option>
                    <option value="3">Location 3</option>
                </select>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Pets Service</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item active d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Pet Purchasing</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Pet Inspection</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Pet Accessories</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Pet Details</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Organization Cleaning</h4>
                        <p class="m-0"> If you have a specific text or phrase you'd like to translate, please provide it, and I'd be happy to help.</p>
                    </div>
                </div>
            </div>
